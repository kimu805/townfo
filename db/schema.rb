...
ActiveRecord::Schema[7.0].define(version: 2024_11_30_024314) do
  ...
  create_table "circulars", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "pending_memberships", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "group_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
